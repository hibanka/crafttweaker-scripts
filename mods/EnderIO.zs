// ИСПРАВЛЕНИЕ РЕЦЕПТОВ
// В моде могут сломаться крафты некоторых вещей (например фотовольтовых ячеек или конденсаторов)
// Сами рецепты отображаются визуально, но скрафтить предметы не получится
	# Резервуар
