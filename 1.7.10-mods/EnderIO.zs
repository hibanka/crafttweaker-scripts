# Исправляем рецепты некоторых вещей, если в моде они сломались (например фотовольтовые ячейки или конденсаторы)
# Багнутые рецепты отображаются визуально, но скрафтить предметы не получится, поэтому и были созданы данные скрипты:
	# Резервуар
